...
with(power0201_0202, {
  ...
  plot(power0201_0202$Time, as.numeric(as.character(power0201_0202$Voltage)), type="l", xlab="datetime", ylab="Voltage")
  ...
  plot(power0201_0202$Time, as.numeric(as.character(power0201_0202$Global_reactive_power)), type="l", xlab="datetime", ylab="Global_reactive_power")
